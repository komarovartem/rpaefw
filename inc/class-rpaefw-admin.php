		...
		<div id="rpaefw-promo">
			...
			<ul class="ul-disc">
				...
				<li>
					...
					<small>
						если используется обычная посылка, но покупатель выбрал наложенный платеж как оплату,
						доставка пересчитается с объявленной стоимостью и тарифами Почты РФ
					</small>
				</li>
				<li>
